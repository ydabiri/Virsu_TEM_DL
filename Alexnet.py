...
################################################################################
with open('/content/finalImages/allVirusesMixedTestTrain/catToName.json', 'r') as f:
    cat_to_name = json.load(f)
################################################################################
alex = torch.hub.load('pytorch/vision:v0.5.0', 'alexnet', pretrained=True)
alex.class_to_idx = image_datasets.class_to_idx
################################################################################
numberFeatures = 9216
outFeaturesS = 512
...
imageDatasetsVal = datasets.ImageFolder('/content/finalImages/allVirusesMixedTestTrain/test', transform=data_transforms)
